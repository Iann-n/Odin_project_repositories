...
export default function loadPage() {
    ...
    content.textContent = "Welcome to modern restaurant page! We got everything you need to satisfy your hungry desires. From plain eggs to space cockroaches, we don't fail to serveeeeeeeee. Slayyyyyyy";
